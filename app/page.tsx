...
function SectionLabel({ children }: { children: string }) {
  return (
    <p className="text-xs tracking-[0.25em] uppercase mb-4 font-bold" style={{ color: FOREST, opacity: 0.5 }}>
      {children}
    </p>
  )
}
        ...
        <div className="flex-none">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-2 mt-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] tracking-[0.2em] uppercase font-bold" style={{ opacity: 0.4 }}>
                Live
              </span>
            </div>
            {PULSE_TARGETS.map((_, i) => (
              <span key={i} className="text-xs" style={{ color: FOREST }}>
                <span className="font-black text-sm" style={{ color: CORAL }}>
                  {pulseCounts[i]}
                </span>
                {' '}
        ...
        <div className="mt-4 pt-12 border-t" style={{ borderColor: `${FOREST}20` }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <span
              ...
              style={{ color: healthColor, transition: 'color 0.4s ease' }}
            >
              {healthStatus}
            </span>
          </div>
